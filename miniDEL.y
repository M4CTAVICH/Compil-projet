%{
    ...
    int yyerror(const char *s) {
        fprintf(stderr, "Erreur de syntaxe   %d : %s\n", N, s);
        return 0; 
    }
...
LISTVAR : idf aff cst_e vg LISTVAR {
        ...
        | idf aff cst_r vg LISTVAR {
            ...
            if (CompType($1, "FLOAT") == 0) {
                printf("    Erreur   %d et    %d : ICOMPATIBILITE   de la variable %s     \n", N, C, $1);
            }
            addQuadruplet("=", $2, NULL, $1);  
        }
        | idf aff cst_r {
        ...
        | idf aff chaine vg LISTVAR {
            ...
            if (CompType($1, "STRING") == 0) {
                printf("    Erreur semantique   %d et    %d : ICOMPATIBILITE   de la variable %s     \n", N, C, $1);
            }
            addQuadruplet("=", $2, NULL, $1);  
        }
        | idf aff chaine {
...
{
    addQuadruplet("while", $2, NULL, "temp");  
}
...
{
    addQuadruplet("do", NULL, NULL, "temp"); 
}
